...
def train(neuralnet, train_data, test_data, epochs, lr, batch_size, device=tc.device('cuda:1')):
    ...
    for epoch in range(epochs):
        ...
        if epoch in [0,10,100, 200, 400, 600,800,1000, 1500, 2000,2500,3000, 3200, 3400, 3600, 3800, 4000, 8000]:
            print(epoch)
            neuralnet.eval()
